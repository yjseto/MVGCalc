...
from gui.components.button import MvgCalcInputButton
...
class BasicKeyboard(QWidget):
    ...
    def __init__(self):
        ...
        Seven 7
        """
        seven = MvgCalcInputButton(NumericInput.SEVEN.textSymbol, width_input_multiplier, height_input_multiplier, self)   
        ...
        Eight 8
        """
        eight = MvgCalcInputButton(NumericInput.EIGHT.textSymbol,width_input_multiplier, height_input_multiplier, self)   
        ...
        Nine 9
        """
        nine = MvgCalcInputButton(NumericInput.NINE.textSymbol,width_input_multiplier, height_input_multiplier, self) 
        ...
        Square Root
        """
        sqrt = MvgCalcInputButton(MathFunction.SQRT.get_no_parentheses(),width_input_multiplier, height_input_multiplier, self)
        ...
        Percent %  
        """
        percent = MvgCalcInputButton(MathFunction.PERCENT.textSymbol, width_input_multiplier, height_input_multiplier, self)  
        ...
        Four 4
        """
        four = MvgCalcInputButton(NumericInput.FOUR.textSymbol, width_input_multiplier, height_input_multiplier, self)   
        ...
        Five 5
        """
        five = MvgCalcInputButton(NumericInput.FIVE.textSymbol, width_input_multiplier, height_input_multiplier, self)   
        ...
        Six 6
        """
        six = MvgCalcInputButton(NumericInput.SIX.textSymbol, width_input_multiplier, height_input_multiplier, self)  
        ...
        Squared
        """
        squared = MvgCalcInputButton("x\u00b2", width_input_multiplier, height_input_multiplier, self)   
        ...
        Division
        """
        division = MvgCalcInputButton(Operator.DIVIDE.textSymbol,width_input_multiplier, height_input_multiplier, self)                                              
        ...
        One 1
        """        
        one = MvgCalcInputButton(NumericInput.ONE.textSymbol, width_input_multiplier, height_input_multiplier,self)   
        ...
        Two 2
        """  
        two = MvgCalcInputButton(NumericInput.TWO.textSymbol, width_input_multiplier, height_input_multiplier, self)   
        ...
        Three 3
        """  
        three = MvgCalcInputButton(NumericInput.THREE.textSymbol, width_input_multiplier, height_input_multiplier, self) 
        ...
        Add +
        """  
        add = MvgCalcInputButton(Operator.ADD.textSymbol, width_input_multiplier, height_input_multiplier, self)   
        ...
        Multiply
        """  
        multiplication = MvgCalcInputButton(Operator.MULTIPLY.textSymbol, width_input_multiplier, height_input_multiplier, self)  
        ...
        Negitive +/-
        """  
        negitive = MvgCalcInputButton("\u207A\u2215\u208B", width_input_multiplier, height_input_multiplier,self)
        ...
        Zero 0
        """          
        zero = MvgCalcInputButton(NumericInput.ZERO.textSymbol,width_input_multiplier, height_input_multiplier, self)
        ...
        Decimal Point .
        """ 
        decimal_point = MvgCalcInputButton(CharacterInput.DECIMAL_POINT.textSymbol, width_input_multiplier, height_input_multiplier, self)   
        ...
        Subtract -
        """ 
        subtract = MvgCalcInputButton(Operator.SUBTRACT.textSymbol,width_input_multiplier, height_input_multiplier, self)   
        ...
        Enter
        """         
        enter = MvgCalcInputButton(ActionKey.ENTER.textSymbol, width_input_multiplier, height_input_multiplier, self)   
...
class FunctionKeyboard(QWidget):
    ...
    def __init__(self):
        ...
        Sin 
        """ 
        sin = MvgCalcInputButton(TrigonometryFunction.SIN.get_no_parentheses(), width_function_multiplier, height_function_multiplier, self)   
        ...
        Cos 
        """ 
        cos = MvgCalcInputButton(TrigonometryFunction.COS.get_no_parentheses(), width_function_multiplier, height_function_multiplier, self)   
        ...
        Tan
        """ 
        tan = MvgCalcInputButton(TrigonometryFunction.TAN.get_no_parentheses(), width_function_multiplier, height_function_multiplier, self)   
        ...
        X
        """          
        x_var = MvgCalcInputButton(CharacterInput.XVAR.textSymbol, width_function_multiplier, height_function_multiplier, self)
        ...
        Sin Inv
        """ 
        invsin = MvgCalcInputButton(TrigonometryFunction.INVSIN.get_no_parentheses(), width_function_multiplier, height_function_multiplier, self)   
        ...
        Cos Inv 
        """ 
        invcos = MvgCalcInputButton(TrigonometryFunction.INVCOS.get_no_parentheses(), width_function_multiplier, height_function_multiplier, self)   
        ...
        Tan Inv
        """ 
        invtan = MvgCalcInputButton(TrigonometryFunction.INVTAN.get_no_parentheses(), width_function_multiplier, height_function_multiplier, self)   
        ...
        Pi
        """          
        pi = MvgCalcInputButton(MathConstants.PI.textSymbol, width_function_multiplier, height_function_multiplier, self)
        ...
        Log
        """ 
        log = MvgCalcInputButton(MathFunction.LOG.get_no_parentheses(), width_function_multiplier, height_function_multiplier, self)   
        ...
        Natural Log
        """ 
        nat_log = MvgCalcInputButton(MathFunction.LOG_NATURAL.get_no_parentheses(), width_function_multiplier, height_function_multiplier, self)   
        ...
        Pow 10
        """ 
        power = MvgCalcInputButton(MathFunction.POW.textSymbol, width_function_multiplier, height_function_multiplier, self)   
        ...
        Eulers #
        """          
        e = MvgCalcInputButton(MathConstants.EULERSNUM.textSymbol, width_function_multiplier, height_function_multiplier, self)
        ...
        Negitive +/-
        """  
        negitive = MvgCalcInputButton("\u207A\u2215\u208B", width_function_multiplier, height_function_multiplier, self)  
        ...
        Zero 0
        """          
        zero = MvgCalcInputButton(NumericInput.ZERO.textSymbol, width_function_multiplier, height_function_multiplier, self)
        ...
        Decimal Point .
        """ 
        decimal_point = MvgCalcInputButton(CharacterInput.DECIMAL_POINT.textSymbol, width_function_multiplier, height_function_multiplier, self)   
        decimal_point.setStyleSheet(component_dark_grey("QPushButton"))
        ...
        Enter
        """         
        enter = MvgCalcInputButton(ActionKey.ENTER.textSymbol, width_function_multiplier, height_function_multiplier, self)   
        enter.setStyleSheet(component_blue("QPushButton",border_bottom_right_radius = "8px"))
...
class HistoricExpressionKeyboard(QWidget):
    ...
    def __init__(self, display_mode : DisplayMode, parent=None):
        ...
        FIRST ROW - Shared Keys
        """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""     
        shared_keys = SharedKeyRow(KeyboardDisplayMode.HISTORIC_EXPRESSIONS)
        main_layout.addWidget(shared_keys) 
        shared_keys.button_click_signal_from_shared_keys.connect(self.handle_button_click)
        """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
class DPad(QWidget):
    ...
    def __init__(self, display_mode : KeyboardDisplayMode = None):
        super().__init__()
        ...
        up_arrow = MvgCalcInputButton(ActionKey.UP.textSymbol, width_input_multiplier * 0.65, height_input_multiplier * 0.4, self)  
        ...
        disable_left_right_buttons = (display_mode == KeyboardDisplayMode.HISTORIC_EXPRESSIONS)

        horizontal_layout = QHBoxLayout()
        left_arrow = MvgCalcInputButton(ActionKey.LEFT.textSymbol, width_input_multiplier * 0.4, height_input_multiplier * 0.65, self)
        left_arrow.setIcon(QtGui.QIcon(ActionKey.LEFT.iconPath))
        left_arrow.setDisabled(disable_left_right_buttons)
        ...
        right_arrow = MvgCalcInputButton(ActionKey.RIGHT.textSymbol, width_input_multiplier * 0.4, height_input_multiplier *0.65, self)
        ...
        down_arrow = MvgCalcInputButton(ActionKey.DOWN.textSymbol, width_input_multiplier *0.65, height_input_multiplier * 0.4, self)
...
class SharedKeyRow(QWidget):
    ...
    def __init__(self, display_mode : KeyboardDisplayMode = None):
        ...
        Clear Button
        """
        if display_mode == KeyboardDisplayMode.HISTORIC_EXPRESSIONS:
            clear = MvgCalcInputButton("Clear All", width_input_multiplier * 2, height_input_multiplier) 
            ...
            clear = MvgCalcInputButton(ActionKey.CLEAR.textSymbol, width_input_multiplier, height_input_multiplier) 
            clear.setStyleSheet(component_light_grey("QPushButton", border_top_left_radius = "8px",max_width = "20px"))
            main_layout.addWidget(clear)
            clear.clicked.connect(
                partial(self.handle_button_click, ActionKey.CLEAR))     
        ...
        if display_mode == KeyboardDisplayMode.HISTORIC_EXPRESSIONS:
            ...
            Left Parenthesis
            """
            left_parethesis = MvgCalcInputButton(CharacterInput.LEFT_P.textSymbol, width_input_multiplier*0.45, height_input_multiplier, self)             
            ...
            Right Parenthesis
            """
            right_parethesis = MvgCalcInputButton(CharacterInput.RIGHT_P.textSymbol, width_input_multiplier*0.45, height_input_multiplier, self)                                                   
        ...
        Backspace
        """
        backspace = MvgCalcInputButton(ActionKey.BACKSPACE.textSymbol, width_input_multiplier, height_input_multiplier)
